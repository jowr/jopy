...
tpl_first_line = "{0} CAUTION: This file is automatically generated from {1}, do not edit it manually - {2}"
...
f.write(tpl_first_line.format("#",template_path,datetime.datetime.today().strftime('%Y-%m-%d')))
